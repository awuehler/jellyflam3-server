...
| Device | Everyday |
|---|---|
| **Roku VoD** | Launch **JellyFlam3** → pick a sheep. Loop plays. Overnight new sheep after a full mix (package 1.0.31). Near the end (**1.0.38**): **OK** love / **Right** like / **Down** dismiss / **Up-Back** exit. Liked genomes can copy to peers overnight if Opt In; receivers still promote. |
