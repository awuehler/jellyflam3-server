...
- **Sheep naming (Phase 4 — RNG shipped 2026-09-09):** auto-generated memorable aliases (`adjective_surname`) on the catalog sidecar; human override; `python3 -m pipeline.sheep_naming`. Optional LLM-from-poster and Roku/Kodi filename vs alias display stay parked. Guide: [phase4/09_SHEEP_NAMING.md](phase4/09_SHEEP_NAMING.md).
