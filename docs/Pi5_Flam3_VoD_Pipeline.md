...
- **Sheep naming (Phase 4 — RNG shipped 2026-09-09):** auto-generated memorable aliases (`adjective_surname`) on the catalog sidecar; human override; `python3 -m pipeline.sheep_naming`. Roku/Kodi filename vs alias display stays parked. **LLM-from-poster → Phase 5** ([phase5/02_LLM_INTEGRATION.md](phase5/02_LLM_INTEGRATION.md)). Guide: [phase4/09_SHEEP_NAMING.md](phase4/09_SHEEP_NAMING.md).
