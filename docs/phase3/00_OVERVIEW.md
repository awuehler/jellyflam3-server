...
- [../phase4/06_LIBRARY_DISK_ROTATE.md](../phase4/06_LIBRARY_DISK_ROTATE.md) — sheep library disk check + rotate (**closed** 2026-09-19); daily cron optional
...
- [../phase4/09_SHEEP_NAMING.md](../phase4/09_SHEEP_NAMING.md) — RNG aliases + VoD / screensaver `titleMode` shipped; optional Jellyfin OriginalTitle parked
