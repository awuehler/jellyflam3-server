...
**Status: complete** — Owner OK 2026-08-16 (extract + sideload). Poster-pipeline Backdrop merge + screensaver 1.0.7 (skip tuple, always rotate, `commercialMode`) 2026-09-08. Mid-session 404 re-poll in screensaver **1.0.8** (2026-09-09). Wrap-once re-fetch + 313 URL cap in screensaver **1.0.9** (2026-09-10).
...
6. ~~**Stills cycle UX**~~ — timed Primary + Backdrop cycle + crossfade; empty/error labels; SS Settings fade/dwell (Owner OK fade controls 2026-08-16; 1.0.7 Backdrop + tuple skip; 1.0.8 404 re-poll; 1.0.9 wrap re-fetch + 313 cap)
