...
Sub-standard examples (non-exhaustive): crushed blacks, neon clash on living-room TVs, near-empty frames, extreme vibrancy, broken aspect after bad hand edits, duration that fails band after dynamic snap, watermark-less masters when watermark policy is on (Phase 4 edges guide).
