...
7. **Screensaver package is not yet cert-clean.** `roku-screensaver/` still has `rsg_version=1.2`, a deprecated `subtitle`, `KeyboardDialog`, no memory-monitor APIs, and no beacons. Fix those before submitting **JellyFlam3 Dreams**.
