...
7. **Phase 4 products stay on Phase 4.** Vote overlay, VoD `titleMode`, library rotate are **not** pulled into this slice. Auto-promote is cancelled on A (`promote --apply`).
