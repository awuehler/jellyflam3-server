...
4. Pasture filename-vs-alias **toggle** is Phase 4 / 09 (Roku VoD `titleMode`, Kodi **0.2.12**, Roku SS **1.0.11**). Optional Jellyfin OriginalTitle / SortName-as-alias stays parked. Pasture still talks to **A**.
...
| **Library disk** | Read A’s `library_disk check` | Auto-purge / rotate is furnace 06, not B | [phase4/06](../phase4/06_LIBRARY_DISK_ROTATE.md) |
